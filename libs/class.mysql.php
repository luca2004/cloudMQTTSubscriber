 ...
 */
	...
	function cDateMySQL2Br($dt) {
		...
		if (strlen($dt) == 10) {
			...
			if ($debug) echo "Date format inv�lid. Use dd/mm/YYYY <br>\n\n";
		}
	...
	function cDateBr2MySQL($dt) {
		...
		if (strlen($dt) == 10) {
			...
			if ($debug) echo "Date format inv�lid [$dt]. Use dd/mm/YYYY <br>\n\n";
		}
	 ...
	 * convert 1 for "Sim" and 0 for "N�o"
	 *
	 * @param $valor
	 * @return int
	 */
	...
	/**
	 * mysql::cBooleanBr2MySQL()
	 * convert "Sim" for 1 and "N�o"for 0
	 *
	 * @param $valor
	 * @return string
	 */
